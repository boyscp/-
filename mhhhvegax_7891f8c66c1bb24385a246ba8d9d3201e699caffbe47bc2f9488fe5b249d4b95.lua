...
local Window = OrionLib:MakeWindow({Name = "SE中心", HidePremium = false, SaveConfig = true,IntroText = "SE中心", ConfigFolder = "SE中心"})
-----------------------------------------------------------------------------------------------------
